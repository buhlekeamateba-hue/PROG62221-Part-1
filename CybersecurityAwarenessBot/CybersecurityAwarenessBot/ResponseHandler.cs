...
namespace CybersecurityAwarenessBot
{
    internal class ResponseHandler
    {
        public string GetResponse(string userInput, string userName)
        {
            ...
            //Phishing
            else if (cleanedInput.Contains("phishing") || cleanedInput.Contains("scam") || cleanedInput.Contains("suspicious email"))
            {
            ...
            //safe browsing 
            else if (cleanedInput.Contains("browsing")) || cleanedInput.Contains("browser") || cleanedInput.Contains("website") || cleanedInput.Contains("safe online"))
                    {
            ...
            //Default response for unrecognised questions
                 ...
                 { return "I did not quite understand that. Could you rephrase? " + "You can ask Cybot about passwords, phishing, or safe browsing.";
            }
        }
    }
}
